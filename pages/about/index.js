...
export const About = () => {
  ...
  return (
    <>
      <Head>
        <title>
          About Us | Our Mission, Vision, & Goal | Premier Pain Centers
        </title>
        ...
        <meta
          name="description"
          content="At Premier Pain Centers, we are dedicated to our mission, our vision, and our goal of helping patients better their lives through quality pain management services."
        />
      ...
      >
        ...
        <div className="main">
          ...
          >
            <ul
              className="flex-grid auto-responsive"
              data-role="list"
