...
export const ConditionsWeTreat = ({ items }) => {
  ...
  return (
    <>
      <Head>
        <title>
          Conditions We Treat | Pain Management | Premier Pain Centers
        </title>
        ...
        <meta
          name="description"
          content="At Premier Pain Centers, we offer pain management treatments for a wide array of conditions. Contact our Richardson facility today for more information!"
        />
      ...
      <main id="MainZone">
          ...
          >
            ...
            <div className="main">
              <div className="flex-auto-responsive-margined flex-direction align-items item-widths">
                ...
                <div
                  className="vertical-padding-small side-padding-small bg-box box-flair border-radius"
                  style={{ zIndex: "0" }}
                >
              ...
              <li className="flex-" data-item="i" data-key="75442">
                ...
                >
                  <picture className="img-bg">
                    <source
                      media="(max-width: 500px)"
                      srcSet="/assets/New-folder/joint-pain.jpg"
        ...
        >
          <picture className="img-bg bg-position" data-role="picture">
            <source
              media="(max-width: 500px)"
              srcSet="/assets/panel-groups/panel-group-v6-bg-mobile.jpg"
              data-src="/assets/panel-groups/panel-group-v6-bg-mobile.jpg"
            />
            <source
              media="(max-width: 1024px)"
              srcSet="/assets/panel-groups/panel-group-v6-bg-tablet.jpg"
          ...
          <div className="box" id="PanelGroupV6Zone">
            ...
            >
              <picture className="img-bg" data-role="picture">
                <source
                  media="(max-width: 500px)"
                  srcSet="/assets/content/content-v3-duplicate-bg.jpg"
                ...
                <Image
                  layout="fill"
                  src="/assets/content/content-v3-duplicate-bg.jpg"
                  alt=""
                  data-src="/assets/content/content-v3-duplicate-bg.jpg"
                />
              </picture>
        ...
        >
          <picture className="img-bg" data-role="picture">
            <source
              media="(max-width: 500px)"
              srcSet="/assets/values/values-v8-bg-mobile.jpg"
              data-src="/assets/values/values-v8-bg-mobile.jpg"
            />
            <Image
              layout="fill"
              src="/assets/values/values-v8-bg.jpg"
              alt=""
            ...
            <div className="flex-margined-auto-responsive-block-1024 item-spacing item-widths align-items flex-direction box-flair">
              ...
              <div className="relative flex-column-end">
                ...
                >
                  <source
                    media="(max-width: 500px)"
                    srcSet="/assets/values/values-v8-img-mobile.jpg"
                    data-src="/assets/values/values-v8-img-mobile.jpg"
                  />
                  <img
                    src="/assets/values/values-v8-img.jpg"
                    alt=""
