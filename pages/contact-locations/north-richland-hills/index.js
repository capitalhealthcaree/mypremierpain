...
export const NorthRichlandHills = () => {
  const router = useRouter();

  return (
    <>
      <Head>
        <title>Pain Management Services in North Richland Hills, TX</title>
        <meta content="text/html; charset=utf-8" httpEquiv="Content-Type" />
        <meta content="initial-scale=1" name="viewport" />
        <meta httpEquiv="X-UA-Compatible" content="IE=edge,chrome=1" />
        <meta
          name="description"
          content="If you are experiencing chronic pain and need relief, contact Premier Pain Centers today to learn more about our pain management services in North Richland Hills."
        />
              ...
              <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
                <div className="flair-border" data-content="true">
                  ...
                  <div
                    ...
                    data-content="true"
                  >
                    <h1>Pain Management in North Richland Hills</h1>
                    <h5>Phone</h5>
                    <h4>
                    ...
                    <h5>Address</h5>
                    <div>7304 NE Loop 820, Ste. C</div>
                    <div>North Richland Hills, TX 76180</div>
                    <div>
                      <Link
                        rel="noreferrer"
                    ...
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3352.5634535715913!2d-97.21031068481658!3d32.83032998095594!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x92d4c26d7da2ff07!2sPremier%20Pain%20Centers!5e0!3m2!1sen!2sus!4v1629317157152!5m2!1sen!2sus"
                      width="600"
                      height="450"
                      style={{ border: "0" }}
                      allowFullScreen=""
