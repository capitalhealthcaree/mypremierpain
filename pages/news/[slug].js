  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://www.mypremierpain.com/news${items && items?.slug}`}
        />
        ...
        <meta
          ...
          content="https://www.mypremierpain.com/"
        />
        <meta
          property="og:url"
          content={`https://www.mypremierpain.com/news${items && items?.slug}`}
        />
...
export const getServerSideProps = async ({ query: { slug } }) => {
  const posts = await axios.get(SSR_ENDPOINT + "news/slug/" + slug + "/");
